	...
	class Avatar {
		...
		_refreshBodyParts() {
			...
			const updateSizes = () => {
				...
				// God damnit Pekora, try to follow your own scaling rules
				// instead of hardcoding stuff like this q.q
				// Well, that's none of my business for pekora I guess.
			...
			accessories.forEach(acc => {
				...
				// Pekora Weirdness: Attachmentless accessories (defaultHatAttachment) do not get position-scaled
				if(acc.attCFrame) {
				...
				// Pekora Weirdness: Mesh.Offset doesn't get position-scaled
				if(acc.offset) {
