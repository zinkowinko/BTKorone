...

{
	...
	const contextMenus = [
		...
		},
		{
			...
			contexts: ["link"],
			targetUrlPatterns: [
				"*://*.pekora.zip/*roup.aspx*gid=*",
				"*://*.pekora.zip/*roups.aspx*gid=*",
				"*://*.pekora.zip/groups/*/*"
			]
		},
		{
			...
			targetUrlPatterns: [
				"*://*.pekora.zip/games/*/*",
				"*://*.pekora.zip/refer?*PlaceId=*",
				"*://*.pekora.zip/games/refer?*PlaceId=*"
			]
		},
		{
			id: "universeLink",
