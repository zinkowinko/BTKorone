...
const SETTINGS = {
	defaultSettings: {
		...
		general: {
			...
			disablePekoraThemes: { default: true, value: false },
			...
			robuxToUSDRate: { default: true, value: "obc85", validValues: ["obc85", "tbc35", "bc15"] },
		...
		gamedetails: {
			...
			addServerPager: { default: true, value: true }, // prob never gonna be implemented
			mockVIPServers: { default: true, value: true },
			newGamesPage: { default: false, value: false} // implemented later
		},
		groups: {
			enabled: { default: true, value: true },
			shoutAlerts: { default: true, value: true },
			redesign: { default: false, value: false },
			modifySmallSocialLinksTitle: { default: false, value: false },
			pagedGroupWall: { default: false, value: false },
			rankInWall: { default: false, value: false}
		},
		inventory: {
			enabled: { default: true, value: true },
...
const PAGE_INFO = {
	...
	tixexchange: {
		matches: ["^/internal/tixexchange"],
		css: []
	},
	robuxexchange: {
		matches: ["^/internal/robuxexchange"],
		css: []
	},
	catalog: {
		matches: ["^/catalog/?$"],
